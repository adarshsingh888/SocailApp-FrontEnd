    ...
    <div className="max-w-4xl sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-lg sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto m-4 bg-white shadow-xl rounded-lg text-gray-900">
      ...
      <div className="rounded-t-lg h-32 overflow-hidden">
        <img
          ...
          src={userr.coverPicture || cover}
          alt={`${userr.firstname}'s cover`}
        />
      </div>
      ...
      <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
        <img
          ...
          src={userr.profilePicture || defaultProfile}
          alt={`${userr.firstname}'s profile`}
        />
      </div>

      {/* User Info */}
      <div className="text-center mt-2">
        <h2 className="font-semibold">{userr.firstname} {userr.lastname}</h2>
